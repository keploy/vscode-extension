...
openRecordPageButton.addEventListener('click', async () => {
  ...
  vscode.postMessage({
    type: "navigate",
    value: "Keploy",
    eventName:"OpenRecordPageButtonClicked"
  });
});
}
...
openTestPageButton.addEventListener('click', async () => {
  ...
  vscode.postMessage({
    type: "navigate",
    value: "Test",
    eventName:"OpenTestPageButtonClicked"
  });
});
...
rerunTestSuiteButton.addEventListener('click', async () => {
  ...
  vscode.postMessage({
    type: "navigate",
    value: "KeployHome",
    eventName:"RerunTestSuiteButtonClicked"
  });
});
  ...
  if(selectedIconButton.textContent == '1'){
    ...
    if (actionStarted == true) {
      vscode.postMessage({
        ...
        eventName: 'StopRecordingCommandSent',
      });
      ...
      vscode.postMessage({
        ...
        value: `Stop Testing`,
        eventName: 'StopTestingCommandSent',
      });
      ...
      vscode.postMessage({
        ...
        eventName: 'NavigateToIntegrationTest',
      });
      ...
      vscode.postMessage({
        type: "navigate",
        value: "Config",
        eventName: 'NavigateToVsCodeHomeScreen',
      });
    }
  } else {
    vscode.postMessage({
...
navigateToConfigButton.addEventListener('click', async () => {
  vscode.postMessage({
    type: "navigate",
    value: "Config",
    eventName: 'NavigateToConfigButtonClicked',
  });
}
);
}
...
backtoHome.addEventListener('click', async () => {
  vscode.postMessage({
    type: "navigate",
    value: "Config",
    eventName: 'BackToHomeButtonClicked',
  });
}
);
}
...
viewTestLogsButton.addEventListener('click', async () => {
  ...
  vscode.postMessage({
    ...
    eventName: 'ViewTestLogsButtonClicked',
  });
});
}
...
viewRecordLogsButton.addEventListener('click', async () => {
  ...
  vscode.postMessage({
    ...
    eventName: 'ViewRecordLogsButtonClicked',
  });
...
startRecordingButton.addEventListener('click', async () => {
  ...
  vscode.postMessage({
    ...
    eventName: 'StartRecordingButtonClicked', // Include eventName
  });
});
}
...
stopRecordingButton.addEventListener('click', async () => {
  ...
  vscode.postMessage({
    type: "stopRecordingCommand",
    value: `Stop Recording`,
    eventName: 'StopRecordingButtonClicked',
  });
});
}
if (startTestButton) {
startTestButton.addEventListener('click', async () => {
  ...
  vscode.postMessage({
    ...
    eventName: 'StartTestingButtonClicked',
...
stopTestButton.addEventListener('click', async () => {
  ...
  vscode.postMessage({
    type: "stopTestingCommand",
    value: `Stop Testing`,
    eventName: 'StopTestingButtonClicked',
  });
});
}
...
viewCompleteSummaryButton.addEventListener('click', async () => {
  ...
  vscode.postMessage({
    ...
    eventName: 'ViewCompleteSummaryButtonClicked',
  });
});
...
initialiseConfigButton.addEventListener('click', async () => {
  ...
  vscode.postMessage({
    ...
    command: command,
    path: path,
    eventName: 'InitialiseConfigButtonClicked',
  });
});
}
...
displayPreviousTestResults.addEventListener('click', async () => {
  ...
  vscode.postMessage({
    type: "stopRecordingCommand",
    value: `Stop Recording`,
    eventName: 'DisplayPreviousTestResultsButtonClicked',
  });
...
openConfigButton.addEventListener('click', async () => {
  ...
  vscode.postMessage({
    type: "stopRecordingCommand",
    value: `Stop Recording`,
    eventName: 'OpenConfigButtonClicked',
  });
...
setupConfigButton.addEventListener('click', async => {
  ...
  vscode.postMessage({
    type: "openConfigFile",
    value: `/keploy.yml`,
    eventName: 'SetupConfigButtonClicked',
  });
});
}
...
if (e.detail.step === 'ci-cd-setup') {
  ...
  vscode.postMessage({
    ...
    eventName: 'CI/CDSetupStepClicked',
...
if (e.detail.step === 'add-users') {
  ...
  vscode.postMessage({
    ...
    eventName:"AddUsersStepClicked-OpenKeployLink"
  });// Example of opening a link
...
vscode.postMessage({
  ...
  eventName: 'getKeployConfigForSvelte',
  ...
  if (recordedTestCasesDiv) {
    ...
    testCaseElement.addEventListener('click', async () => {
      vscode.postMessage({
        ...
        value: message.path,
        eventName: 'OpenRecordedTestFileClicked',
      });
    });
