var app = (function () {
	...
	function create_else_block(ctx) {
		...
		const block = {
			c: function create() {
				...
				add_location(path0, file, 179, 107, 5355);
				...
				add_location(path1, file, 179, 207, 5455);
				attr_dev(svg, "xmlns", "http://www.w3.org/2000/svg");
				attr_dev(svg, "width", "35px");
				attr_dev(svg, "height", "35px");
				attr_dev(svg, "viewBox", "0 0 24 24");
				add_location(svg, file, 179, 20, 5268);
			},
	...
	function create_if_block_1(ctx) {
		...
		const block = {
			c: function create() {
				...
				add_location(path, file, 177, 107, 5056);
				attr_dev(svg, "xmlns", "http://www.w3.org/2000/svg");
				attr_dev(svg, "width", "35px");
				attr_dev(svg, "height", "35px");
				attr_dev(svg, "viewBox", "0 0 24 24");
				add_location(svg, file, 177, 20, 4969);
			},
			m: function mount(target, anchor) {
				insert_dev(target, svg, anchor);
				append_dev(svg, path);
	...
	function create_if_block(ctx) {
		...
		dispatch_dev("SvelteRegisterBlock", {
			...
			type: "if",
			source: "(197:8) {#if selectedIconButton === 1}",
			ctx
		});
	...
	function create_fragment(ctx) {
		...
		const block = {
			c: function create() {
				...
				attr_dev(input0, "class", "svelte-6nzeft");
				add_location(input0, file, 156, 12, 4163);
				attr_dev(div0, "id", "appCommandDiv");
				attr_dev(div0, "class", "svelte-6nzeft");
				add_location(div0, file, 155, 8, 4126);
				attr_dev(button0, "id", "selectRecordFolderButton");
				attr_dev(button0, "class", "button svelte-6nzeft");
				add_location(button0, file, 165, 12, 4429);
				attr_dev(input1, "type", "text");
				attr_dev(input1, "id", "projectFolder");
				attr_dev(input1, "name", "projectFolder");
				attr_dev(input1, "class", "svelte-6nzeft");
				toggle_class(input1, "isVisible", /*isProjectFolderVisible*/ ctx[7]);
				add_location(input1, file, 166, 12, 4525);
				attr_dev(div1, "id", "selectFolderDiv");
				attr_dev(div1, "class", "svelte-6nzeft");
				add_location(div1, file, 164, 8, 4390);
				attr_dev(button1, "class", button1_class_value = "icon-button " + (/*selectedIconButton*/ ctx[6] === 1 ? 'selected' : '') + " svelte-6nzeft");
				add_location(button1, file, 175, 12, 4808);
				...
				add_location(path0, file, 183, 103, 5872);
				attr_dev(svg0, "xmlns", "http://www.w3.org/2000/svg");
				attr_dev(svg0, "width", "35px");
				attr_dev(svg0, "height", "35px");
				attr_dev(svg0, "viewBox", "0 0 24 24");
				add_location(svg0, file, 183, 16, 5785);
				attr_dev(button2, "class", button2_class_value = "icon-button " + (/*selectedIconButton*/ ctx[6] === 2 ? 'selected' : '') + " svelte-6nzeft");
				add_location(button2, file, 182, 12, 5662);
				...
				add_location(path1, file, 186, 103, 6446);
				attr_dev(svg1, "xmlns", "http://www.w3.org/2000/svg");
				attr_dev(svg1, "width", "35px");
				attr_dev(svg1, "height", "35px");
				attr_dev(svg1, "viewBox", "0 0 24 24");
				add_location(svg1, file, 186, 16, 6359);
				attr_dev(button3, "class", button3_class_value = "icon-button " + (/*selectedIconButton*/ ctx[6] === 3 ? 'selected' : '') + " svelte-6nzeft");
				add_location(button3, file, 185, 12, 6236);
				attr_dev(div2, "class", "icon-buttons svelte-6nzeft");
				add_location(div2, file, 174, 8, 4769);
				add_location(hr, file, 189, 8, 7206);
				attr_dev(h30, "id", "recordStatus");
				attr_dev(h30, "class", "svelte-6nzeft");
				add_location(h30, file, 190, 8, 7220);
				attr_dev(div3, "id", "recordedTestCases");
				attr_dev(div3, "class", "svelte-6nzeft");
				add_location(div3, file, 191, 8, 7257);
				attr_dev(h31, "id", "testStatus");
				attr_dev(h31, "class", "svelte-6nzeft");
				add_location(h31, file, 192, 8, 7300);
				attr_dev(div4, "id", "testResults");
				attr_dev(div4, "class", "svelte-6nzeft");
				add_location(div4, file, 193, 8, 7335);
				attr_dev(button4, "id", "viewCompleteSummaryButton");
				attr_dev(button4, "class", "svelte-6nzeft");
				add_location(button4, file, 195, 8, 7381);
				attr_dev(div5, "class", "loader svelte-6nzeft");
				attr_dev(div5, "id", "loader");
				add_location(div5, file, 202, 8, 7903);
				attr_dev(button5, "id", "stopRecordingButton");
				attr_dev(button5, "class", "svelte-6nzeft");
				add_location(button5, file, 203, 8, 7950);
				attr_dev(button6, "id", "stopTestingButton");
				attr_dev(button6, "class", "svelte-6nzeft");
				add_location(button6, file, 204, 8, 8042);
				attr_dev(div6, "class", "menu");
				add_location(div6, file, 154, 4, 4099);
				attr_dev(main, "class", "svelte-6nzeft");
				add_location(main, file, 153, 0, 4088);
			},
			...
			m: function mount(target, anchor) {
				...
				if (!mounted) {
					dispose = [
						...
						listen_dev(button2, "click", /*click_handler_1*/ ctx[14], false, false, false, false),
						listen_dev(button3, "click", /*click_handler_2*/ ctx[15], false, false, false, false),
			...
			p: function update(ctx, [dirty]) {
				...
				if (dirty & /*selectedIconButton*/ 64 && button1_class_value !== (button1_class_value = "icon-button " + (/*selectedIconButton*/ ctx[6] === 1 ? 'selected' : '') + " svelte-6nzeft")) {
					attr_dev(button1, "class", button1_class_value);
				}

				if (dirty & /*selectedIconButton*/ 64 && button2_class_value !== (button2_class_value = "icon-button " + (/*selectedIconButton*/ ctx[6] === 2 ? 'selected' : '') + " svelte-6nzeft")) {
					attr_dev(button2, "class", button2_class_value);
				}

				if (dirty & /*selectedIconButton*/ 64 && button3_class_value !== (button3_class_value = "icon-button " + (/*selectedIconButton*/ ctx[6] === 3 ? 'selected' : '') + " svelte-6nzeft")) {
