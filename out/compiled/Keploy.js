	...
	function create_else_block(ctx) {
		...
		const block = {
			c: function create() {
				...
				add_location(path0, file, 333, 107, 10908);
				...
				add_location(path1, file, 333, 207, 11008);
				attr_dev(svg, "xmlns", "http://www.w3.org/2000/svg");
				attr_dev(svg, "width", "35px");
				attr_dev(svg, "height", "35px");
				attr_dev(svg, "viewBox", "0 0 24 24");
				add_location(svg, file, 333, 20, 10821);
			},
	...
	function create_if_block_2(ctx) {
		...
		const block = {
			c: function create() {
				...
				add_location(path, file, 331, 107, 10609);
				attr_dev(svg, "xmlns", "http://www.w3.org/2000/svg");
				attr_dev(svg, "width", "35px");
				attr_dev(svg, "height", "35px");
				attr_dev(svg, "viewBox", "0 0 24 24");
				add_location(svg, file, 331, 20, 10522);
			},
			m: function mount(target, anchor) {
				insert_dev(target, svg, anchor);
				append_dev(svg, path);
	...
	function create_if_block_1(ctx) {
		...
		const block = {
			c: function create() {
				...
				attr_dev(h30, "class", "svelte-dfoq7z");
				add_location(h30, file, 347, 8, 12878);
				attr_dev(div0, "id", "recordedTestCases");
				attr_dev(div0, "class", "svelte-dfoq7z");
				add_location(div0, file, 348, 8, 12915);
				attr_dev(button0, "id", "prevPageButton");
				attr_dev(button0, "class", "svelte-dfoq7z");
				add_location(button0, file, 351, 12, 13036);
				attr_dev(button1, "id", "nextPageButton");
				attr_dev(button1, "class", "svelte-dfoq7z");
				add_location(button1, file, 353, 12, 13169);
				attr_dev(div1, "class", "pagination-buttons svelte-dfoq7z");
				attr_dev(div1, "id", "pagination-buttons");
				add_location(div1, file, 350, 8, 12967);
				attr_dev(h31, "id", "testStatus");
				attr_dev(h31, "class", "svelte-dfoq7z");
				add_location(h31, file, 355, 8, 13254);
				attr_dev(div2, "id", "testResults");
				attr_dev(div2, "class", "svelte-dfoq7z");
				add_location(div2, file, 356, 8, 13289);
				attr_dev(button2, "id", "viewCompleteSummaryButton");
				attr_dev(button2, "class", "svelte-dfoq7z");
				add_location(button2, file, 357, 8, 13326);
				attr_dev(button3, "id", "startRecordingButton");
				attr_dev(button3, "class", "button svelte-dfoq7z");
				button3.disabled = button3_disabled_value = /*isRecording*/ ctx[4] && /*isTesting*/ ctx[5];
				add_location(button3, file, 358, 12, 13413);
				attr_dev(button4, "id", "startTestingButton");
				attr_dev(button4, "class", "button svelte-dfoq7z");
				button4.disabled = button4_disabled_value = /*isRecording*/ ctx[4] && /*isTesting*/ ctx[5];
				add_location(button4, file, 361, 12, 13625);
			},
			m: function mount(target, anchor) {
		...
		dispatch_dev("SvelteRegisterBlock", {
			...
			type: "if",
			source: "(347:8) {#if selectedIconButton === 1}",
			ctx
		});
	...
	function create_if_block(ctx) {
		...
		const block = {
			c: function create() {
				...
				attr_dev(h3, "class", "svelte-dfoq7z");
				add_location(h3, file, 375, 12, 14554);
				attr_dev(div, "id", "lastTestResults");
				add_location(div, file, 374, 8, 14515);
			},
			m: function mount(target, anchor) {
		...
		dispatch_dev("SvelteRegisterBlock", {
			...
			type: "if",
			source: "(374:8) {#if selectedIconButton === 2}",
			ctx
		});
	...
	function create_fragment(ctx) {
		...
		const block = {
			c: function create() {
				...
				attr_dev(input0, "class", "svelte-dfoq7z");
				add_location(input0, file, 310, 12, 9696);
				attr_dev(div0, "id", "appCommandDiv");
				attr_dev(div0, "class", "svelte-dfoq7z");
				add_location(div0, file, 309, 8, 9659);
				attr_dev(button0, "id", "selectRecordFolderButton");
				attr_dev(button0, "class", "button svelte-dfoq7z");
				add_location(button0, file, 319, 12, 9962);
				attr_dev(input1, "type", "text");
				attr_dev(input1, "id", "projectFolder");
				attr_dev(input1, "name", "projectFolder");
				attr_dev(input1, "class", "svelte-dfoq7z");
				toggle_class(input1, "isVisible", /*isProjectFolderVisible*/ ctx[7]);
				add_location(input1, file, 320, 12, 10058);
				attr_dev(div1, "id", "selectFolderDiv");
				attr_dev(div1, "class", "svelte-dfoq7z");
				add_location(div1, file, 318, 8, 9923);
				attr_dev(button1, "id", "keploycommands");
				attr_dev(button1, "class", button1_class_value = "icon-button " + (/*selectedIconButton*/ ctx[6] === 1 ? 'selected' : '') + " svelte-dfoq7z");
				add_location(button1, file, 329, 12, 10341);
				...
				add_location(path0, file, 337, 103, 11457);
				attr_dev(svg0, "xmlns", "http://www.w3.org/2000/svg");
				attr_dev(svg0, "width", "35px");
				attr_dev(svg0, "height", "35px");
				attr_dev(svg0, "viewBox", "0 0 24 24");
				add_location(svg0, file, 337, 16, 11370);
				attr_dev(button2, "id", "displayPreviousTestResults");
				attr_dev(button2, "class", button2_class_value = "icon-button " + (/*selectedIconButton*/ ctx[6] === 2 ? 'selected' : '') + " svelte-dfoq7z");
				add_location(button2, file, 336, 12, 11215);
				...
				add_location(path1, file, 340, 103, 12047);
				attr_dev(svg1, "xmlns", "http://www.w3.org/2000/svg");
				attr_dev(svg1, "width", "35px");
				attr_dev(svg1, "height", "35px");
				attr_dev(svg1, "viewBox", "0 0 24 24");
				add_location(svg1, file, 340, 16, 11960);
				attr_dev(button3, "id", "openConfig");
				attr_dev(button3, "class", button3_class_value = "icon-button " + (/*selectedIconButton*/ ctx[6] === 3 ? 'selected' : '') + " svelte-dfoq7z");
				add_location(button3, file, 339, 12, 11821);
				attr_dev(div2, "class", "icon-buttons svelte-dfoq7z");
				add_location(div2, file, 328, 8, 10302);
				add_location(hr, file, 343, 8, 12807);
				attr_dev(h30, "class", "info");
				attr_dev(h30, "id", "keployConfigInfo");
				add_location(h30, file, 364, 12, 13852);
				attr_dev(div3, "id", "keployConfigInfoDiv");
				attr_dev(div3, "class", "svelte-dfoq7z");
				add_location(div3, file, 363, 8, 13809);
				attr_dev(h31, "class", "info");
				add_location(h31, file, 367, 12, 14008);
				attr_dev(input2, "class", "configInput svelte-dfoq7z");
				attr_dev(input2, "type", "text");
				attr_dev(input2, "id", "configCommand");
				attr_dev(input2, "name", "command");
				attr_dev(input2, "placeholder", "Command");
				add_location(input2, file, 369, 12, 14145);
				attr_dev(input3, "class", "configInput svelte-dfoq7z");
				attr_dev(input3, "type", "text");
				attr_dev(input3, "id", "configPath");
				attr_dev(input3, "name", "path");
				attr_dev(input3, "placeholder", "Path (Default value : ./)");
				add_location(input3, file, 370, 12, 14255);
				attr_dev(div4, "id", "initialiseConfig");
				attr_dev(div4, "class", "svelte-dfoq7z");
				add_location(div4, file, 366, 9, 13968);
				attr_dev(button4, "id", "initialiseConfigButton");
				attr_dev(button4, "class", "button svelte-dfoq7z");
				add_location(button4, file, 372, 8, 14390);
				attr_dev(div5, "class", "loader svelte-dfoq7z");
				attr_dev(div5, "id", "loader");
				add_location(div5, file, 384, 8, 14909);
				attr_dev(button5, "id", "stopRecordingButton");
				attr_dev(button5, "class", "svelte-dfoq7z");
				add_location(button5, file, 385, 8, 14956);
				attr_dev(button6, "id", "stopTestingButton");
				attr_dev(button6, "class", "svelte-dfoq7z");
				add_location(button6, file, 386, 8, 15048);
				attr_dev(div6, "class", "menu");
				add_location(div6, file, 308, 4, 9632);
				attr_dev(main, "class", "svelte-dfoq7z");
				add_location(main, file, 307, 0, 9621);
			},
			...
			p: function update(ctx, [dirty]) {
				...
				if (dirty & /*selectedIconButton*/ 64 && button1_class_value !== (button1_class_value = "icon-button " + (/*selectedIconButton*/ ctx[6] === 1 ? 'selected' : '') + " svelte-dfoq7z")) {
					attr_dev(button1, "class", button1_class_value);
				}

				if (dirty & /*selectedIconButton*/ 64 && button2_class_value !== (button2_class_value = "icon-button " + (/*selectedIconButton*/ ctx[6] === 2 ? 'selected' : '') + " svelte-dfoq7z")) {
					attr_dev(button2, "class", button2_class_value);
				}

				if (dirty & /*selectedIconButton*/ 64 && button3_class_value !== (button3_class_value = "icon-button " + (/*selectedIconButton*/ ctx[6] === 3 ? 'selected' : '') + " svelte-dfoq7z")) {
