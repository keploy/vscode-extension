	...
	function create_else_block(ctx) {
		...
		const block = {
			c: function create() {
				...
				add_location(path0, file, 297, 107, 9677);
				...
				add_location(path1, file, 297, 207, 9777);
				attr_dev(svg, "xmlns", "http://www.w3.org/2000/svg");
				attr_dev(svg, "width", "35px");
				attr_dev(svg, "height", "35px");
				attr_dev(svg, "viewBox", "0 0 24 24");
				add_location(svg, file, 297, 20, 9590);
			},
	...
	function create_if_block_2(ctx) {
		...
		const block = {
			c: function create() {
				...
				add_location(path, file, 295, 107, 9378);
				attr_dev(svg, "xmlns", "http://www.w3.org/2000/svg");
				attr_dev(svg, "width", "35px");
				attr_dev(svg, "height", "35px");
				attr_dev(svg, "viewBox", "0 0 24 24");
				add_location(svg, file, 295, 20, 9291);
			},
			m: function mount(target, anchor) {
				insert_dev(target, svg, anchor);
				append_dev(svg, path);
	...
	function create_if_block_1(ctx) {
		...
		const block = {
			c: function create() {
				...
				add_location(button3, file, 321, 12, 12173);
				...
				add_location(button4, file, 324, 12, 12385);
			},
			m: function mount(target, anchor) {
	...
	function create_fragment(ctx) {
		...
		const block = {
			c: function create() {
				...
				add_location(input1, file, 284, 12, 8827);
				attr_dev(div1, "id", "selectFolderDiv");
				attr_dev(div1, "class", "svelte-1qbsu14");
				add_location(div1, file, 282, 8, 8692);
				...
				add_location(button1, file, 293, 12, 9110);
				...
				add_location(path0, file, 301, 103, 10226);
				attr_dev(svg0, "xmlns", "http://www.w3.org/2000/svg");
				attr_dev(svg0, "width", "35px");
				attr_dev(svg0, "height", "35px");
				attr_dev(svg0, "viewBox", "0 0 24 24");
				add_location(svg0, file, 301, 16, 10139);
				...
				add_location(button2, file, 300, 12, 9984);
				...
				add_location(path1, file, 304, 103, 10816);
				attr_dev(svg1, "xmlns", "http://www.w3.org/2000/svg");
				attr_dev(svg1, "width", "35px");
				attr_dev(svg1, "height", "35px");
				attr_dev(svg1, "viewBox", "0 0 24 24");
				add_location(svg1, file, 304, 16, 10729);
				...
				add_location(button3, file, 303, 12, 10590);
				attr_dev(div2, "class", "icon-buttons svelte-1qbsu14");
				add_location(div2, file, 292, 8, 9071);
				...
				add_location(main, file, 271, 0, 8390);
			},
