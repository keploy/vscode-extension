var app = (function () {
	...
	*/
	...
	function create_else_block_1(ctx) {
		...
		const block = {
			c: function create() {
				...
				add_location(path0, file, 383, 84, 11177);
				...
				add_location(path1, file, 383, 184, 11277);
				attr_dev(svg, "xmlns", "http://www.w3.org/2000/svg");
				attr_dev(svg, "class", "w-9 h-9");
				attr_dev(svg, "viewBox", "0 0 24 24");
				add_location(svg, file, 383, 8, 11101);
			},
	...
	function create_if_block_6(ctx) {
		...
		const block = {
			c: function create() {
				...
				add_location(path, file, 381, 84, 10909);
				attr_dev(svg, "xmlns", "http://www.w3.org/2000/svg");
				attr_dev(svg, "class", "w-9 h-9");
				attr_dev(svg, "viewBox", "0 0 24 24");
				add_location(svg, file, 381, 8, 10833);
			},
			m: function mount(target, anchor) {
				insert_dev(target, svg, anchor);
				append_dev(svg, path);
	...
	function create_else_block(ctx) {
		...
		const block = {
			c: function create() {
				...
				add_location(h1, file, 411, 8, 12941);
			},
			m: function mount(target, anchor) {
	...
	function create_if_block_5(ctx) {
		...
		const block = {
			c: function create() {
				...
				attr_dev(h1, "class", "text-2xl m-0");
				add_location(h1, file, 409, 8, 12860);
			},
			m: function mount(target, anchor) {
				insert_dev(target, h1, anchor);
			},
	...
	function create_if_block_4(ctx) {
		...
		const block = {
			c: function create() {
				...
				attr_dev(h1, "class", "text-2xl m-0");
				add_location(h1, file, 407, 8, 12748);
			},
			m: function mount(target, anchor) {
				insert_dev(target, h1, anchor);
			},
		...
		dispatch_dev("SvelteRegisterBlock", {
			...
			type: "if",
			source: "(407:6) {#if selectedIconButton === 3}",
			ctx
		});
	...
	function create_if_block_3(ctx) {
		...
		const block = {
			c: function create() {
				...
				add_location(h3, file, 450, 6, 14976);
				attr_dev(div, "id", "lastTestResults");
				add_location(div, file, 449, 4, 14942);
			},
			m: function mount(target, anchor) {
		...
		dispatch_dev("SvelteRegisterBlock", {
			...
			type: "if",
			source: "(449:2) {#if selectedIconButton === 2}",
			ctx
		});
	...
	function create_if_block(ctx) {
		...
		const block = {
			c: function create() {
				...
				add_location(div, file, 486, 4, 16658);
			},
			m: function mount(target, anchor) {
				insert_dev(target, div, anchor);
	...
	// (493:8) {#each replayingSteps as step}
	function create_each_block_1(ctx) {
		...
		const block = {
			c: function create() {
				...
				add_location(div, file, 493, 10, 16947);
			},
			m: function mount(target, anchor) {
				insert_dev(target, div, anchor);
			},
		...
		dispatch_dev("SvelteRegisterBlock", {
			...
			type: "each",
			source: "(493:8) {#each replayingSteps as step}",
			ctx
		});
	...
	// (489:8) {#each recordingSteps as step}
	function create_each_block(ctx) {
		...
		const block = {
			c: function create() {
				...
				div.textContent = `${/*step*/ ctx[28]}`;
				attr_dev(div, "class", "mb-2");
				add_location(div, file, 489, 10, 16820);
			},
			m: function mount(target, anchor) {
				insert_dev(target, div, anchor);
			},
		...
		dispatch_dev("SvelteRegisterBlock", {
			...
			type: "each",
			source: "(489:8) {#each recordingSteps as step}",
			ctx
		});
	...
	function create_fragment(ctx) {
		...
		const block = {
			c: function create() {
				...
				add_location(span0, file, 379, 6, 10654);
				attr_dev(button0, "id", "keploycommands");

				attr_dev(button0, "class", button0_class_value = "flex justify-center items-center bg-[var(--vscode-button-secondaryBackground)] rounded-md text-[#FF914D] text-2xl h-10 w-[80vw] cursor-pointer hover:text-[#ff9933] hover:bg-[#606060] group " + (/*selectedIconButton*/ ctx[6] === 1
				? 'bg-[#00163D]'
				: ''));

				add_location(button0, file, 374, 4, 10310);
				attr_dev(span1, "class", "history-icon");
				add_location(span1, file, 391, 6, 11817);
				...
				add_location(span2, file, 392, 6, 11859);
				attr_dev(button1, "id", "displayPreviousTestResults");

				attr_dev(button1, "class", button1_class_value = "flex justify-center items-center bg-[var(--vscode-button-secondaryBackground)] rounded-md text-[#FF914D] text-2xl h-10 w-[80vw] cursor-pointer hover:text-[#ff9933] hover:bg-[#606060] group " + (/*selectedIconButton*/ ctx[6] === 2
				? 'bg-[#00163D]'
				: ''));

				add_location(button1, file, 386, 4, 11461);
				attr_dev(span3, "class", "settings-icon");
				add_location(span3, file, 399, 6, 12358);
				...
				add_location(span4, file, 400, 6, 12401);
				attr_dev(button2, "id", "openConfig");

				attr_dev(button2, "class", button2_class_value = "flex justify-center items-center bg-[var(--vscode-button-secondaryBackground)] rounded-md text-[#FF914D] text-2xl h-10 w-[80vw] cursor-pointer hover:text-[#ff9933] hover:bg-[#606060] group " + (/*selectedIconButton*/ ctx[6] === 3
				? 'bg-[#00163D]'
				: ''));

				add_location(button2, file, 394, 4, 12018);
				...
				add_location(div0, file, 373, 2, 10182);
				attr_dev(path0, "fill", "#FF914D");
				...
				add_location(path0, file, 422, 84, 13444);
				attr_dev(svg0, "xmlns", "http://www.w3.org/2000/svg");
				attr_dev(svg0, "class", "w-9 h-9");
				attr_dev(svg0, "viewBox", "0 0 24 24");
				add_location(svg0, file, 422, 8, 13368);
				...
				add_location(span5, file, 413, 6, 13078);
				attr_dev(path1, "fill", "#FF914D");
				...
				add_location(path1, file, 433, 84, 13996);
				attr_dev(svg1, "xmlns", "http://www.w3.org/2000/svg");
				attr_dev(svg1, "class", "w-9 h-9");
				attr_dev(svg1, "viewBox", "0 0 24 24");
				add_location(svg1, file, 433, 8, 13920);
				...
				add_location(span6, file, 424, 6, 13634);
				attr_dev(div1, "class", "flex items-center justify-around text-center");
				add_location(div1, file, 405, 4, 12642);
				attr_dev(h30, "id", "recordStatus");
				attr_dev(h30, "class", "text-center font-bold my-5 svelte-1q2qpv3");
				add_location(h30, file, 437, 6, 14260);
				attr_dev(div2, "id", "recordedTestCases");
				attr_dev(div2, "class", "grid grid-cols-1 place-items-center svelte-1q2qpv3");
				add_location(div2, file, 438, 6, 14330);
				attr_dev(h31, "id", "testStatus");
				attr_dev(h31, "class", "text-center svelte-1q2qpv3");
				add_location(h31, file, 439, 6, 14416);
				attr_dev(div3, "id", "testResults");
				attr_dev(div3, "class", "grid grid-cols-1 place-items-center my-5 text-left svelte-1q2qpv3");
				add_location(div3, file, 440, 6, 14469);
				attr_dev(button3, "id", "viewCompleteSummaryButton");
				attr_dev(button3, "class", "w-full my-2.5 svelte-1q2qpv3");
				add_location(button3, file, 441, 6, 14564);
				attr_dev(button4, "id", "viewTestLogsButton");
				attr_dev(button4, "class", "w-full my-2.5 svelte-1q2qpv3");
				add_location(button4, file, 442, 6, 14668);
				attr_dev(button5, "id", "viewRecordLogsButton");
				attr_dev(button5, "class", "w-full my-2.5 svelte-1q2qpv3");
				add_location(button5, file, 443, 6, 14750);
				attr_dev(hr, "id", "completeSummaryHr");
				attr_dev(hr, "class", "hidden svelte-1q2qpv3");
				add_location(hr, file, 444, 6, 14834);
				attr_dev(div4, "class", "grid place-items-center");
				attr_dev(div4, "id", "statusdiv");
				add_location(div4, file, 436, 4, 14200);
				attr_dev(div5, "class", "flex flex-col items-center justify-center mb-8 mt-7");
				add_location(div5, file, 404, 2, 12571);
				...
				add_location(path2, file, 465, 84, 15619);
				...
				add_location(div13, file, 470, 4, 16021);
				attr_dev(div14, "class", "mb-8");
				attr_dev(div14, "id", "buttonsSection");
				add_location(div14, file, 454, 2, 15031);
				attr_dev(div15, "class", "hidden");
				attr_dev(div15, "id", "loader");
				add_location(div15, file, 498, 2, 17032);
				attr_dev(div16, "class", "p-4 font-sans");
				add_location(div16, file, 372, 0, 10151);
			},
			...
			p: function update(ctx, dirty) {
				...
				if (dirty[0] & /*selectedIconButton*/ 64 && button0_class_value !== (button0_class_value = "flex justify-center items-center bg-[var(--vscode-button-secondaryBackground)] rounded-md text-[#FF914D] text-2xl h-10 w-[80vw] cursor-pointer hover:text-[#ff9933] hover:bg-[#606060] group " + (/*selectedIconButton*/ ctx[6] === 1
				? 'bg-[#00163D]'
				: ''))) {
					attr_dev(button0, "class", button0_class_value);
				}

				if (dirty[0] & /*selectedIconButton*/ 64 && button1_class_value !== (button1_class_value = "flex justify-center items-center bg-[var(--vscode-button-secondaryBackground)] rounded-md text-[#FF914D] text-2xl h-10 w-[80vw] cursor-pointer hover:text-[#ff9933] hover:bg-[#606060] group " + (/*selectedIconButton*/ ctx[6] === 2
				? 'bg-[#00163D]'
				: ''))) {
					attr_dev(button1, "class", button1_class_value);
				}

				if (dirty[0] & /*selectedIconButton*/ 64 && button2_class_value !== (button2_class_value = "flex justify-center items-center bg-[var(--vscode-button-secondaryBackground)] rounded-md text-[#FF914D] text-2xl h-10 w-[80vw] cursor-pointer hover:text-[#ff9933] hover:bg-[#606060] group " + (/*selectedIconButton*/ ctx[6] === 3
				? 'bg-[#00163D]'
				: ''))) {
