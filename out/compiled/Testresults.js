var app = (function () {
	...
	function create_fragment(ctx) {
		...
		const block = {
			c: function create() {
				...
				attr_dev(div0, "class", "loader svelte-17jnapo");
				attr_dev(div0, "id", "loader");
				add_location(div0, file, 95, 2, 3980);
				attr_dev(div1, "class", "keploylogo");
				attr_dev(div1, "alt", "Keploy Logo");
				set_style(div1, "height", "30px");
				add_location(div1, file, 97, 4, 4044);
				attr_dev(h2, "class", "info");
				add_location(h2, file, 103, 4, 4147);
				attr_dev(div2, "id", "topGrid");
				attr_dev(div2, "class", "svelte-17jnapo");
				add_location(div2, file, 96, 2, 4021);
				add_location(hr, file, 105, 2, 4193);
				add_location(p0, file, 109, 6, 4310);
				attr_dev(div3, "id", "testSuiteName");
				attr_dev(div3, "class", "info svelte-17jnapo");
				add_location(div3, file, 108, 4, 4266);
				add_location(p1, file, 112, 6, 4382);
				attr_dev(div4, "id", "totalTestCases");
				attr_dev(div4, "class", "info svelte-17jnapo");
				add_location(div4, file, 111, 4, 4337);
				add_location(p2, file, 115, 6, 4459);
				attr_dev(div5, "id", "testCasesPassed");
				attr_dev(div5, "class", "success svelte-17jnapo");
				add_location(div5, file, 114, 4, 4410);
				add_location(p3, file, 118, 6, 4535);
				attr_dev(div6, "id", "testCasesFailed");
				attr_dev(div6, "class", "error svelte-17jnapo");
				add_location(div6, file, 117, 4, 4488);
				attr_dev(div7, "id", "completeTestSummaryGrid");
				attr_dev(div7, "class", "svelte-17jnapo");
				add_location(div7, file, 107, 2, 4227);
				attr_dev(button, "id", "rerunTestSuiteButton");
				attr_dev(button, "class", "svelte-17jnapo");
				add_location(button, file, 121, 2, 4571);
				attr_dev(body, "class", "baloo-2-custom");
				add_location(body, file, 94, 0, 3948);
			},
			...
			m: function mount(target, anchor) {
				...
				if (!mounted) {
					dispose = listen_dev(button, "click", /*handleReRun*/ ctx[0], false);
					mounted = true;
				}
			},
			p: noop,
	...
	function instance($$self, $$props, $$invalidate) {
		...
		Object.keys($$props).forEach(key => {
			if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console_1.warn(`<Testresults> was created with unknown prop '${key}'`);
		});

		$$self.$capture_state = () => ({ onMount, handleReRun });
		return [handleReRun];
	}
