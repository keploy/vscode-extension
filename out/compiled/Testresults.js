	...
	function create_fragment(ctx) {
		...
		const block = {
			c: function create() {
				...
				attr_dev(div0, "class", "loader svelte-188d9ks");
				attr_dev(div0, "id", "loader");
				add_location(div0, file, 4, 4, 31);
				attr_dev(img, "class", "keploylogo svelte-188d9ks");
