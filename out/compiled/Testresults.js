var app = (function () {
	...
	/* webviews\components\Testresults.svelte generated by Svelte v4.2.17 */
	const file = "webviews\\components\\Testresults.svelte";
	...
	function create_fragment(ctx) {
		...
		const block = {
			c: function create() {
				...
				add_location(div0, file, 5, 4, 90);
				attr_dev(div1, "class", "flex justify-center mt-5 mb-5 w-full h-[10%] keploylogo h-[30px]");
				attr_dev(div1, "alt", "Keploy Logo");
				add_location(div1, file, 7, 6, 204);
				attr_dev(h2, "class", "text-primary-300 text-center mt-1");
				add_location(h2, file, 12, 6, 350);
				attr_dev(div2, "class", "grid grid-cols-2 place-items-center");
				attr_dev(div2, "id", "topGrid");
				add_location(div2, file, 6, 4, 134);
				attr_dev(hr, "class", "my-2");
				add_location(hr, file, 14, 4, 431);
				add_location(p0, file, 18, 8, 646);
				attr_dev(div3, "id", "testSuiteName");
				attr_dev(div3, "class", "text-primary-300 text-center mt-1");
				add_location(div3, file, 17, 6, 570);
				add_location(p1, file, 21, 8, 756);
				attr_dev(div4, "id", "totalTestCases");
				attr_dev(div4, "class", "text-primary-300 text-center mt-1");
				add_location(div4, file, 20, 6, 679);
				add_location(p2, file, 24, 8, 867);
				attr_dev(div5, "id", "testCasesPassed");
				attr_dev(div5, "class", "text-accent-100 text-center mt-1");
				add_location(div5, file, 23, 6, 790);
				add_location(p3, file, 27, 8, 981);
				attr_dev(div6, "id", "testCasesFailed");
				attr_dev(div6, "class", "text-[#9c1a0c] text-center mt-1.25");
				add_location(div6, file, 26, 6, 902);
				attr_dev(div7, "class", "grid grid-cols-4 place-items-center");
				attr_dev(div7, "id", "completeTestSummaryGrid");
				add_location(div7, file, 16, 4, 484);
				attr_dev(button, "id", "rerunTestSuiteButton");
				attr_dev(button, "class", "mx-auto block w-[90%] h-[30px] py-1 px-2 mt-5");
				add_location(button, file, 30, 4, 1026);
				attr_dev(body, "class", "baloo-2-custom");
				add_location(body, file, 4, 2, 55);
			},
