var app = (function () {
	...
	function create_fragment(ctx) {
		...
		const block = {
			c: function create() {
				div4 = element("div");
				h1 = element("h1");
				h1.textContent = "Welcome to Keploy";
				t1 = space();
				h2 = element("h2");
				h2.textContent = "Your AI Generator Tool";
				t3 = space();
				div0 = element("div");
				div0.innerHTML = ``;
				t4 = space();
	...
	function instance($$self, $$props, $$invalidate) {
		...
		$$self.$inject_state = $$props => {
			...
			if ('appCommand' in $$props) appCommand = $$props.appCommand;
			if ('noise' in $$props) noise = $$props.noise;
