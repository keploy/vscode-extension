var app = (function () {
	...
	// (98:8) {#each Object.keys(flags) as flag}
	function create_each_block(ctx) {
		...
		const block = {
			c: function create() {
				...
				add_location(option, file, 98, 10, 3152);
			},
		...
		dispatch_dev("SvelteRegisterBlock", {
			...
			type: "each",
			source: "(98:8) {#each Object.keys(flags) as flag}",
			ctx
		});
	...
	function create_fragment(ctx) {
		...
		const block = {
			c: function create() {
				...
				attr_dev(a, "class", "homebutton svelte-1f9onjn");
				add_location(a, file, 69, 2, 2355);
				attr_dev(button0, "id", "selectRecordFolderButton");
				attr_dev(button0, "class", "secondary svelte-1f9onjn");
				add_location(button0, file, 72, 4, 2446);
				...
				attr_dev(input0, "class", "svelte-1f9onjn");
				add_location(input0, file, 75, 4, 2549);
				attr_dev(div0, "id", "selectFolderDiv");
				attr_dev(div0, "class", "svelte-1f9onjn");
				add_location(div0, file, 71, 2, 2415);
				attr_dev(button1, "id", "enterAppCommandButton");
				button1.disabled = "true";
				attr_dev(button1, "class", "secondary svelte-1f9onjn");
				add_location(button1, file, 83, 4, 2717);
				attr_dev(input1, "type", "text");
				attr_dev(input1, "id", "recordCommand");
				attr_dev(input1, "name", "recordCommand");
				attr_dev(input1, "placeholder", "Enter App Command");
				attr_dev(input1, "class", "svelte-1f9onjn");
				add_location(input1, file, 86, 4, 2829);
				attr_dev(div1, "id", "appCommandDiv");
				attr_dev(div1, "class", "svelte-1f9onjn");
				add_location(div1, file, 82, 2, 2688);
				option.__value = "";
				set_input_value(option, option.__value);
				option.disabled = true;
				option.selected = true;
				add_location(option, file, 96, 8, 3043);
				attr_dev(select, "id", "selectflags");
				attr_dev(select, "class", "svelte-1f9onjn");
				add_location(select, file, 95, 6, 3009);
				attr_dev(div2, "id", "flags");
				add_location(div2, file, 94, 4, 2986);
				attr_dev(input2, "type", "text");
				attr_dev(input2, "id", "flagValueInput");
				attr_dev(input2, "placeholder", "Enter Value");
				attr_dev(input2, "class", "svelte-1f9onjn");
				add_location(input2, file, 103, 6, 3263);
				attr_dev(div3, "id", "flagValue");
				add_location(div3, file, 102, 4, 3236);
				attr_dev(div4, "id", "flagsDiv");
				attr_dev(div4, "class", "svelte-1f9onjn");
				add_location(div4, file, 93, 2, 2962);
				attr_dev(button2, "id", "startRecordingButton");
				button2.disabled = "true";
				attr_dev(button2, "class", "svelte-1f9onjn");
				add_location(button2, file, 106, 2, 3353);
				add_location(hr, file, 108, 2, 3431);
				attr_dev(img, "class", "keploylogo svelte-1f9onjn");
				...
				add_location(img, file, 111, 6, 3497);
				add_location(h30, file, 116, 6, 3643);
				attr_dev(div5, "id", "upperOutputDiv");
				attr_dev(div5, "class", "svelte-1f9onjn");
				add_location(div5, file, 110, 4, 3465);
				attr_dev(h1, "id", "generatedRecordCommand");
				attr_dev(h1, "class", "svelte-1f9onjn");
				add_location(h1, file, 119, 6, 3709);
				attr_dev(div6, "id", "recordCommandDiv");
				add_location(div6, file, 118, 4, 3675);
				attr_dev(div7, "class", "loader svelte-1f9onjn");
				attr_dev(div7, "id", "loader");
				add_location(div7, file, 121, 4, 3775);
				attr_dev(button3, "id", "stopRecordingButton");
				attr_dev(button3, "class", "svelte-1f9onjn");
				add_location(button3, file, 122, 4, 3818);
				attr_dev(h31, "id", "recordStatus");
				attr_dev(h31, "class", "svelte-1f9onjn");
				add_location(h31, file, 123, 4, 3879);
				attr_dev(div8, "id", "recordedTestCases");
				attr_dev(div8, "class", "svelte-1f9onjn");
				add_location(div8, file, 124, 4, 3912);
				attr_dev(div9, "id", "outputDiv");
				add_location(div9, file, 109, 2, 3440);
