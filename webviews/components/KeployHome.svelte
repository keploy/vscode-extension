<script>
  ...
  $: {
    ...
    if (backConfigButton) {
      ...
      backConfigButton.style.display =
        selectedIconButton != 2 && selectedIconButton != 3 ? "block" : "none";
    }
...
<div class="container">
  <div>
    <h1 id="selectedIconNumber" class="selectedIconClass">
      {selectedIconButton}
    </h1>
  </div>
  <div class="container-card">
    <div class="header-button">
      ...
      <div class="icon-buttons">
        ...
        <a
          href="https://join.slack.com/t/keploy/shared_invite/zt-2rak7xfq9-KgZDi0qzW350ZO8nzo08VA"
          target="_blank"
        >
          <button id="openConfig" class="icon-button">
          ...
          <div class="settings-form">
            ...
            <div class="form-group">
              ...
              <input
                id="mongoPassword"
                type="text"
                bind:value={mongoPassword}
              />
            </div>

            <!-- Save button -->
            <div class="card" on:click={saveSettings}>
    ...
    <div class="stepper-container" id="progress-stepper">
      ...
      <div class="step">
        ...
        >
          ...
          <span class="timeline-icon">
            ...
            >
              <path
                d="M400 733.333C584.095 733.333 733.333 584.095 733.333 400C733.333 215.905 584.095 66.6667 400 66.6667C215.905 66.6667 66.6665 215.905 66.6665 400C66.6665 584.095 215.905 733.333 400 733.333Z"
                stroke="currentColor"
                stroke-width="50"
              />
              <path
                d="M400 533.333C473.638 533.333 533.333 473.638 533.333 400C533.333 326.362 473.638 266.667 400 266.667C326.362 266.667 266.667 326.362 266.667 400C266.667 473.638 326.362 533.333 400 533.333Z"
                stroke="currentColor"
                stroke-width="50"
              />
            </svg>
      ...
      <div class="step">
        <span
          class="step-number {currentStep >= 5
            ? 'activeStep pointer'
            : 'InactiveStep'}"
          on:click={handleStepClick(currentStep)}
        >
          ...
          <span class="timeline-icon">
            ...
            >
              <path
                d="M566.667 700V633.333C566.667 597.971 552.619 564.057 527.614 539.052C502.609 514.048 468.695 500 433.333 500H166.667C131.304 500 97.3905 514.048 72.3857 539.052C47.3808 564.057 33.3333 597.971 33.3333 633.333V700"
                stroke="currentColor"
              ...
              />
              <path
                d="M300 366.667C373.638 366.667 433.333 306.971 433.333 233.333C433.333 159.695 373.638 100 300 100C226.362 100 166.667 159.695 166.667 233.333C166.667 306.971 226.362 366.667 300 366.667Z"
                stroke="currentColor"
                stroke-width="66.6667"
                stroke-linecap="round"
                stroke-linejoin="round"
...
<style>
  ...
  @media screen and (max-width: 480px) {
    ...
    .activeStep .timeline-icon {
      ...
      ); /* Set to var(--vscode-editor-foreground); when active */
    }
